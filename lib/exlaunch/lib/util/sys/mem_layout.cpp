...
static void FindRegions() {
    ...
    if (R_FAILED(
            TryGetAddressFromInfo(InfoType_AslrRegionAddress, &util::mem_layout::s_Aslr.m_Start)) ||
        R_FAILED(
            TryGetAddressFromInfo(InfoType_AslrRegionSize, &util::mem_layout::s_Aslr.m_Size)) ||
        R_FAILED(TryGetAddressFromInfo(InfoType_StackRegionAddress,
                                       &util::mem_layout::s_Stack.m_Start)) ||
        R_FAILED(
            TryGetAddressFromInfo(InfoType_StackRegionSize, &util::mem_layout::s_Stack.m_Size))) {
